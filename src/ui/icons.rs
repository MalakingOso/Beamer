...
pub fn IconClockCounterClockwise(props: IconProps) -> Element {
    ...
    rsx! {
        svg {
            ...
            fill: "currentColor",
            path {
                d: "M136,24A104,104,0,0,0,54,64.29L34.34,44.69A8,8,0,0,0,20.69,48.34,8,8,0,0,0,20.69,54L54,87.31a8,8,0,0,0,5.66,2.34h.09a8,8,0,0,0,5.66-2.34l33.37-33.37a8,8,0,0,0-11.31-11.32L68.84,61.26A88,88,0,1,1,48,128a8,8,0,0,0-16,0A104,104,0,1,0,136,24Zm-8,56a8,8,0,0,0-8,8v40a8,8,0,0,0,3.06,6.31l32,25.6a8,8,0,1,0,9.94-12.55L136,124.94V88A8,8,0,0,0,128,80Z"
            }
        }
    }
}
